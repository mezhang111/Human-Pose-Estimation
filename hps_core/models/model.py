...
class Model(nn.Module):
    def __init__(self, img_res=224):
        ...
        self.head = ModelHead2(num_input_features=512 if backbone in ['resnet18', 'resnet34'] else 2048)
        self.smpl = SMPLHead(focal_length=5000., img_res=img_res)

    def forward(self, images): #image shape [128,128]
        #p_enc_2d = PositionalEncodingPermute2D(3)
        #pos_encode = p_enc_2d(images)
